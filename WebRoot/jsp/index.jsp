     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">MusicNet</a>
            </div>
            <!-- /.navbar-header -->
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="javascript:alert('reading')">
            ...
            <!-- mainPage /.navbar-static-side -->
        </nav>
        <!-- 
        <div id="mainPage" style="height:500px">
        	<iframe name="mainFr" id="mainFr" allowTransparency="true" frameborder="0"width="100%" height="100%" src="http://localhost:7001/" >
        	</iframe>
        </div>
         -->
